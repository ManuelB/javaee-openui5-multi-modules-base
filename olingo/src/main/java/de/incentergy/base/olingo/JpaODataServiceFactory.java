...
public abstract class JpaODataServiceFactory extends ODataJPAServiceFactory {
	...
	public ODataJPAContext initializeODataJPAContext() throws ODataJPARuntimeException {
		...
		try {
			...
			EntityManager entityManager = (EntityManager) initialContext.lookup(getJNDIEntityManagerName());
			...
			EntityManagerFactory entityManagerFactory = (EntityManagerFactory) initialContext
					.lookup(getJNDIEntityManagerFactoryName());
	...
	public String getJNDIEntityManagerFactoryName() {
		return "java:/"+getPersistenceUnitName()+"EntityManagerFactory";
	}

	public String getJNDIEntityManagerName() {
		return "java:/"+getPersistenceUnitName()+"EntityManager";
	}
}